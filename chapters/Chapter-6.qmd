...
- __Cholesterol__ 胆固醇 alters membrane fluidity
...
- __Integral membrane proteins__ 整合膜蛋白 are at least partly embedded in the phospholipid bilayer.
...
- __Peripheral membrane proteins__ 周边膜蛋白 lack exposed hydrophobic groups.
...
- __Anchored membrane protein__ 锚定膜蛋白 are covalently attached to fatty acids or other lipid groups.
...
- In addition to having one or more __transmembrane domains__ 跨膜区 that [extends all the way through the bilayer]{.underline} such a protein may have [domains with other specific functions]{.underline} on the [inner and outer sides of the membrane]{.underline}.
...
- A __glycolipid__ 糖脂类 consists of a carbohydrate covalently bonded to a lipid.
...
:::{.practice title = "6.1 Recap and Assess"}
1. How do the hydrophobic and hydrophilic regions of phospholipids form a membrane bilayer?
